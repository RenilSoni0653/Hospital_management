            ...
            <form method="POST" action="{{ url('/profile') }}">
                ...
                <div class="card-body">
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $doctor->name ?? old('name') }}" autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $doctor->email }}" autocomplete="email" autofocus>
                ...
                <div class="card-header">Doctor Dashboard</div>
                    ...
                    <table width="100%">
                        <tr>
                            <td><a href="{{ url('/profile/'.'/edit') }}">Edit Profile</a></td>
                            <td><a href="/appointment/create">Book Appointment</a></td>
                        </tr>
                        
                        <tr>
                            <td><a href="#">Show booked Appointment</a></td>
                            <td><a href="/profile/changePwd">Change Password</a></td>
                        </tr>
                    </table>
                    </div>
                @endif
